...
> PS: Yes, I did use AI to help me cosntruct the all the tests, the first MNIST sample, the fft to test in multi gpu, most importantly, to document and organize the entire homelab setup process, testing, and how I ran each of the algorithms and SNNs.
